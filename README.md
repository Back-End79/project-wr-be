...
```
cd existing_repo
git remote add origin https://gitlab.cloudias79.com/internal-apps/portal-working-report/portal-wr-be.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.cloudias79.com/internal-apps/portal-working-report/portal-wr-be/-/settings/integrations)
...
String likeKeyword = "%" + keyword.toLowerCase() + "%";
      ...
      Predicate searchPredicate = criteriaBuilder.or(projectNamePredicate, taskNamePredicate, taskCodePredicate,
          userNamePredicate);
